...
export const videos: VideoItem[] = [
  {
    ...
    description:
      "Reprehenderit exercitation laborum ex consectetur mollit est qui. Commodo aute ea aliquip adipisicing amet pariatur tempor eiusmod aliqua sunt. Sit do minim deserunt excepteur ex deserunt sit qui. Sit elit proident cillum fugiat ipsum excepteur nulla voluptate exercitation proident minim. Occaecat in sint ullamco quis commodo.",
  },
  {
    videoSource: VideoSource.YOUTUBE,
